...
import { faCheckToSlot, faClose, faStar, faUserMd } from '@fortawesome/free-solid-svg-icons';
import Loader from '../../Loader';


const DoctorListModalS =  ({ isOpen, onClose, specialityID, specialityName }) => {
    ...
    const fetchDoctors = async () => {
        ...
        try {
            ...
            const response = await axios.post(`${backendUrl}/api/admin/get-doctors-by-speciality`, {specialityID});
      ...
      <div className="bg-white p-6 rounded-lg shadow-xl w-[90%] max-w-3xl max-h-[90%] overflow-y-auto relative">
        ...
        {doctors.length > 0 ? (
          ...
          <p className="text-gray-500 italic text-center">
            Nu există medici activi în această specialitate.
          </p>
        )}
...
export default DoctorListModalS